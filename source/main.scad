...
module main()
{
  ...
  // gantry
  color([0.20, 0.20, 0.20]) translate([-(240+3),-202.5,20]) pulley_front_left();
  color([0.20, 0.20, 0.20]) translate([+(240+3),-202.5,20])  pulley_front_right();
  color([0.20, 0.20, 0.20]) translate([-225,220,-30]) rotate([0,0,-90]) motor_and_pulley_back_left();
  color([0.20, 0.20, 0.20]) translate([225,220,-30]) rotate([0,0,-90]) motor_and_pulley_back_right();
  color([0.20, 0.20, 0.20]) translate([0,220,0]) rotate([0,0,180]) belt_tentioner();
...
module x_movement()
{
  ...
  translate([- 150,- 152.14 + 65,0]) carriage();
}
