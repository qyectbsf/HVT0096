  ...
  difference()
    {
      ...
      // space for idler
      translate([-16.5, 30, upper_belt_idler_z]) pulley_cutout(21);
...
{
  translate([0,0,upper_belt_z - 2]) rotate([90,0,0]) gates_2gt_20t_toothed_idler();
}
  ...
  difference()
    {
      ...
      // space for idler
      translate([16.5, 30, lower_belt_idler_z]) pulley_cutout(21);
...
{
  translate([0,0,lower_belt_z - 2]) rotate([90,0,0]) gates_2gt_20t_toothed_idler();
}
