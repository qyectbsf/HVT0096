  ...
  union()
  {
    difference()
    {
      union()
      {
        ...
        union()
        {
          translate([-15.0, 21.0 - 6.0, 0.0]) cube([82.0, 6.0, 100.0]);
          translate([-15.0, 69.0 - 48.0, lower_belt_z + 19.8]) cube([82.0, 48.0, 6.0]);

          for ( x = [-15.0, 61.0])
          {
            hull()
            {
              translate([x, 21.0 - 6.0, 0.0]) cube([6.0, 6.0, 100.0]);
              translate([x, 69.0 - 48.0, lower_belt_z + 19.8]) cube([6.0, 48.0, 6.0]);
            }
          }
        }
        ...
        union()
        {
          ...
          hull()
          {
            translate([motor_offset_x - 1.75, 21.0 - 6.0, lower_belt_z + 25.8])
              cube([34.25, 6.0, 26.0]);
            translate([motor_offset_x + 15.5, -(motor_offset_y + 15.5), lower_belt_z + 25.8])
              cylinder(d = 19.0, h = 26.0, $fn = resolution);
          }
          // motor upper bearing
          hull()
          {
            translate([motor_offset_x - 10.75, 21.0 - 6.0, lower_belt_z + 39.8])
              cube([43.25, 6.0, 12.0]);
            translate([motor_offset_x, -motor_offset_y, lower_belt_z + 39.8])
      ...
      translate([motor_offset_x, -motor_offset_y, lower_belt_z + 19.7])
      ...
      for (j = [0.0, 1.0, 3.0])
      {
        translate([motor_offset_x, -motor_offset_y, 0.0])
          ...
          translate([-15.5, 15.5, lower_belt_z + 15.79])
          cylinder(h = 17, d = 3.5, $fn = resolution);
      }

      // belt hole in primary structure
      translate([17.0, 20.95 - 6.0, lower_belt_z + 30 - 1])
        cube([7.0, 6.1, 10.8]);
      translate([60.9, 28.0 - 7.0, lower_belt_z + 30 - 1])
        cube([7.0, 7.0, 10.8]);

      // alu profile mount hole
      for (i = [9.0, 60.0, 91.0])
      {
        translate([0.0, 14.9 + 6.2, i])
          rotate([90.0, 0.0, 0.0])
          cylinder(d = m6_screw, h = 6.2, $fn = resolution);
      }
      translate([52.0, 14.9 + 6.2, 15.0])
        rotate([90.0, 0.0, 0.0])
        cylinder(d = m6_screw, h = 6.2, $fn = resolution);

      // idler cut out
      translate([motor_offset_x + 15.5, -(motor_offset_y + 15.5), lower_belt_z + 17.8])
        cylinder(d = 3mm_stab, h = 35.0, $fn = resolution);

      // belt cutout in secundary structure
      hull()
      {
        translate([motor_offset_x + 15.5, -(motor_offset_y + 15.5), lower_belt_z + 29.0])
          cylinder(d = 19.0, h = 10.8, $fn = resolution);
        translate([motor_offset_x, -motor_offset_y, lower_belt_z + 29.0])
          cylinder(d = 20.0, h = 10.8, $fn = resolution);
        translate([60.9, 28.0 - 7.0, lower_belt_z + 29.0])
          cube([7.0, 7.0, 10.8]);
      }
    }
    translate([motor_offset_x + 15.5, -(motor_offset_y + 15.5), lower_belt_z + 29.0])
...
module pulley_back_right()
{
  ...
  union()
  {
    difference()
    {
      ...
      translate([14.9, -8.9, z_offset]) cube([20.2, 24.0, belts_max_space]);
      translate([14.9, -15.1, z_offset]) cube([9.0, 30.2, belts_max_space]);
    ...
    difference()
    {
      ...
      translate([10.74 + x, -(15 -2.92 + y), z_offset + 10.8 + 0.35])
        pulley_cutout(19.5);
...
module motor_and_pulley_back_right()
{
  difference()
  {
    union()
