    ...
    difference()
    {
      union()
      {
        ...
        union()
        {
          ...
          hull()
          {
            translate([motor_offset_x - 1.75, -21.0, upper_belt_z + 25.8])
              cube([34.25, 6.0, 26.0]);
            translate([motor_offset_x + 15.5, motor_offset_y + 15.5, upper_belt_z + 25.8])
              cylinder(d = 19.0, h = 26.0, $fn = resolution);
          }
          // motor upper bearing
          hull()
          {
            translate([motor_offset_x - 10.75, -21.0, upper_belt_z + 39.8])
              cube([43.25, 6.0, 12.0]);
            translate([motor_offset_x, motor_offset_y, upper_belt_z + 39.8])
      ...
      translate([motor_offset_x, motor_offset_y, upper_belt_z + 19.7])
      ...
      for (j = [0.0, 1.0, 2.0])
      {
        translate([motor_offset_x, motor_offset_y, 0.0])
          ...
          translate([-15.5, 15.5, upper_belt_z + 15.79])
      ...
      // idler cut out
      translate([motor_offset_x + 15.5, motor_offset_y + 15.5, upper_belt_z + 17.8])
